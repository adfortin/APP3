			...
			try {
				...
				if (liaison.validateTrameCRC(receivedtrame)) {
					...
					case 0:
						...
						break;
					case 1:
						// System.out.println("Manque packet no: " + (receivedtrame.getPacketNumberInt()
						// /*- 1 (à enlever ) */));
					...
					// System.out.println("CRC du paquet no: " + new
					// String(receivedtrame.getPacketNumber()) + " non valide!!!!");
